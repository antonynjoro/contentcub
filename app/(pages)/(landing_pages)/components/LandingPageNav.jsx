...
export default function LandingPageNav() {
  ...
  return (
    <section className=" sticky top-0 z-50 overflow-hidden bg-white">
      <div className="bg-tarnsparent">
        <nav className="flex justify-between p-6 px-4">
          <div className="flex w-full items-center justify-between">
            ...
            <div className="w-2/3 xl:w-1/3">
              <ul className="hidden gap-5 xl:flex xl:justify-around">
                <li className="">
                  <Link
        ...
        <div
          className={`navbar-menu bg-coolGray-900 fixed left-0 top-0 z-50  h-full w-full bg-gray-950/50 bg-opacity-50 shadow-lg transition-all ease-in-out ${
                ...
                <div className="flex flex-wrap">
                  ...
                  {isSignedIn && (
                    <div className="flex flex-col">
                      <Link
                        className=" mr-2 inline-block rounded-md bg-transparent px-4 py-2 font-medium leading-5 text-gray-900"
                        href="/checklists"
                      >
                        Go to App
                      </Link>
