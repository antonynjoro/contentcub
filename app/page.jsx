            ...
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <img
                  ...
                  src="/logo.svg?color=gray&shade=600"
                  alt=""
                />
              </a>
              <button
                ...
                >
                    ...
                    <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                      {tier.features.map((feature) => (
                        <li key={feature} className="flex gap-x-3">
                          <HiCheck className="h-6 w-5 flex-none text-gray-600" aria-hidden="true" />
                          {feature}
                        </li>
                      ))}
                    </ul>
                  ...
                  <a
                    ...
                    className={classNames(
                      ...
                      'mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600'
                    )}
                  >
                    Buy plan
                  </a>
